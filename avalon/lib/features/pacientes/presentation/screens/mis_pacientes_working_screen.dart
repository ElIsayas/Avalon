...
class MisPacientesWorkingScreen extends ConsumerStatefulWidget {
  const MisPacientesWorkingScreen({super.key});

  @override
  ConsumerState<MisPacientesWorkingScreen> createState() => _MisPacientesWorkingScreenState();
}

class _MisPacientesWorkingScreenState extends ConsumerState<MisPacientesWorkingScreen> {
