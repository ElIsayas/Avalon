...
class MisPacientesFixedScreen extends ConsumerStatefulWidget {
  const MisPacientesFixedScreen({super.key});

  @override
  ConsumerState<MisPacientesFixedScreen> createState() => _MisPacientesFixedScreenState();
}

class _MisPacientesFixedScreenState extends ConsumerState<MisPacientesFixedScreen> {
