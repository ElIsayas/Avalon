...
class MisPacientesSimpleScreen extends ConsumerStatefulWidget {
  const MisPacientesSimpleScreen({super.key});

  @override
  ConsumerState<MisPacientesSimpleScreen> createState() => _MisPacientesSimpleScreenState();
}

class _MisPacientesSimpleScreenState extends ConsumerState<MisPacientesSimpleScreen> {
