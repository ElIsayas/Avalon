...
class CitasService {
  ...
  Future<List<Cita>> getCitas({
    ...
    try {
      ...
      AppLogger.database('Error obteniendo citas: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Cita>> getCitasHoy() async {
    ...
    try {
      final res = await _client.rpc('get_citas_hoy', params: {'p_token': _token});
      final lista = (res as List? ?? [])
          .map((e) => Cita.fromJson(e as Map<String, dynamic>))
          .toList();
      ...
      AppLogger.database('Error obteniendo citas de hoy: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Cita>> getCitasSemana() async {
    ...
    try {
      final res = await _client.rpc('get_citas_semana', params: {'p_token': _token});
      final lista = (res as List? ?? [])
          .map((e) => Cita.fromJson(e as Map<String, dynamic>))
          .toList();
      ...
      AppLogger.database('Error obteniendo citas de la semana: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Cita> crearCita({
    ...
    try {
      ...
      AppLogger.database('Error creando cita: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> actualizarCita({
    ...
    try {
      ...
      if (fechaHora != null) params['p_fecha_hora'] = fechaHora.toIso8601String();
      if (duracionMinutos != null) params['p_duracion_minutos'] = duracionMinutos;
      if (estado != null) params['p_estado'] = estado;
      if (esOnline != null) params['p_es_online'] = esOnline;
      if (notas != null) params['p_notas'] = notas;
      if (motivoCancelacion != null) params['p_motivo_cancelacion'] = motivoCancelacion;
      ...
      AppLogger.database('Error actualizando cita: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Cita>> getProximasCitasPsicologo({int limite = 10}) async {
    ...
    try {
      ...
      AppLogger.database('Error obteniendo próximas citas: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<DisponibilidadPsicologo>> getDisponibilidadPsicologos() async {
    ...
    try {
      final res = await _client.rpc('get_disponibilidad_psicologos', params: {'p_token': _token});
      final lista = (res as List? ?? [])
          .map((e) => DisponibilidadPsicologo.fromJson(e as Map<String, dynamic>))
          .toList();

      AppLogger.database('Se obtuvo disponibilidad de ${lista.length} psicólogos');
      return lista;
    } catch (e, stackTrace) {
      AppLogger.database('Error obteniendo disponibilidad: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }

  Future<List<Recordatorio>> getRecordatorios() async {
    AppLogger.database('Obteniendo recordatorios');
    
    try {
      final res = await _client.rpc('get_recordatorios', params: {'p_token': _token});
      final lista = (res as List? ?? [])
          .map((e) => Recordatorio.fromJson(e as Map<String, dynamic>))
          .where((r) => !r.resuelto)
          .toList();

      AppLogger.database('Se obtuvieron ${lista.length} recordatorios activos');
      return lista;
    } catch (e, stackTrace) {
      AppLogger.database('Error obteniendo recordatorios: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> crearRecordatorio({
    ...
    AppLogger.database('Creando recordatorio: $titulo');
    
    try {
      final res = await _client.rpc('crear_recordatorio', params: {
        'p_token': _token,
        'p_titulo': titulo,
      ...
      AppLogger.database('Recordatorio creado exitosamente');
      return data;
    } catch (e, stackTrace) {
      AppLogger.database('Error creando recordatorio: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }

  Future<Map<String, dynamic>> resolverRecordatorio(String recordatorioId) async {
    AppLogger.database('Resolviendo recordatorio $recordatorioId');
    ...
    try {
      ...
      AppLogger.database('Recordatorio resuelto exitosamente');
      return data;
    } catch (e, stackTrace) {
      AppLogger.database('Error resolviendo recordatorio: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }

  Future<Map<String, dynamic>> eliminarRecordatorio(String recordatorioId) async {
    AppLogger.database('Eliminando recordatorio $recordatorioId');
    ...
    try {
      ...
      AppLogger.database('Recordatorio eliminado exitosamente');
      return data;
    } catch (e, stackTrace) {
      AppLogger.database('Error eliminando recordatorio: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getAuditoriaCita(String citaId) async {
    ...
    try {
      ...
      AppLogger.database('Se obtuvieron ${lista.length} registros de auditoría');
      return lista;
    } catch (e, stackTrace) {
      AppLogger.database('Error obteniendo auditoría: $e', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
}
